...
async def getOwnNFTs(w3):
    ...
    machineContractAddress = [ca for ca in dict(filter(lambda elem: elem[1] == "mta", caToType.items()))]
    patientContractAddress = [ca for ca in dict(filter(lambda elem: elem[1] == "pta", caToType.items()))]
    prescriptionContractAddress = [ca for ca in dict(filter(lambda elem: elem[1] == "preta", caToType.items()))]
    dataContractAddress = [ca for ca in dict(filter(lambda elem: elem[1] == "dta", caToType.items()))]
