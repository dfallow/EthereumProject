...
@app.route('/ProcessFilesInfo/<string:inputInfo>/<string:doctorAddress>/<string:patientAddress>', methods=['POST'])
def ProcessFilesInfo(inputInfo, doctorAddress, patientAddress):
    # pass the multiple files data and do something with it
    deployMachineData.deploy_nfts(inputInfo, doctorAddress, patientAddress)
    return('/')    
