...
print("DataItemAdded", contract_deployed.events.DataItemAdded())
contract_deployed.functions.addDataItem(file_hash, file_url).call()
print("DataItemAdded2", contract_deployed.events.DataItemAdded())
